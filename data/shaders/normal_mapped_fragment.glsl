...
void main()
{
	...
	vec3 sampled_normal = texture(normal_tex, frag_tex_coord).xyz;
	...
	vec3 material_color = texture(diffuse_tex, frag_tex_coord).xyz;
	...
	vec3 material_specular = texture(specular_tex, frag_tex_coord).xyz;
